...
BGM_FILES = ["Pygame_2D/fig/BGM.mp3",
             "Pygame_2D/fig/baadakkuman.mp3",
             "Pygame_2D/fig/kessen.mp3",
             "Pygame_2D/fig/ajito.mp3",
             "Pygame_2D/fig/maou-kessen.mp3"
             ]
...
pygame.init()      
screen = pygame.display.set_mode((640, 480)) #表示画面の大きさ指定
pygame.display.set_caption("Avoid it!!") 
heart_image = pygame.image.load("Pygame_2D/images/heart.png")
...
class Octo_Cat:
    def __init__(self,x,y):
        ...
        self.y = y
        #画像
        self.rough_image = pygame.image.load("Pygame_2D/images/greenoctocat.png").convert()
        #通常時の大きさ指定
...
def open():
    ...
    font2 = pygame.font.Font("Pygame_2D/ipaexg.ttf", 30)
    font3 = pygame.font.SysFont(None, 60)
    text1 = font1.render("Avoid it!!", False, (255,255,255))
    text2 = font2.render("・右シフトで無敵＆ハート回復", False, (255,255,255))
    text3 = font2.render("・左シフトで加速", False, (255,255,255))
    text4 = font2.render("・pキーでポーズ画面(もう一度押すと解除)", False, (255,255,255))
    text5 = font3.render("Press Any Key to Start", False, (255,255,255))


    # 開始BGMを再生
    pygame.mixer.music.load('Pygame_2D/fig/jokyoku.mp3')  # 開始BGMのファイル名に置き換える
...
def play_game_over_music():
    ...
    game_over_sound = pygame.mixer.Sound('Pygame_2D/fig/dead.wav')
...
def main():
    ...
    while endFlag == False:
        ...
        if(octo_cat.immunity == True):#ジャンプ中か確認
